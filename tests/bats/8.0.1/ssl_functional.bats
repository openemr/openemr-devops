# BATS: 8.0.1 ssl.sh — functional tests (run script and check behavior)
...
@test "8.0.1 ssl: runs without crashing when DOMAIN unset" {
...
@test "8.0.1 ssl: output contains expected message or error" {
    run bash -c "'$SSL' 2>&1"
...
@test "8.0.1 ssl: with stub openssl that fails, script does not crash" {
