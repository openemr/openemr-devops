# BATS: 8.0.1 fsupgrade-1.sh — functional test (directory creation in temp site)
...
@test "8.0.1 fsupgrade-1: creates documents subdirs when run with substituted path" {
...
@test "8.0.1 fsupgrade-1: script is idempotent for directory creation" {
