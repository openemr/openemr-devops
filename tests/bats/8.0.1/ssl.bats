# BATS: 8.0.1 ssl.sh — SSL/TLS configuration
...
@test "8.0.1 ssl.sh: uses set -e" {
    assert_script_contains "${SCRIPT_DIR}/ssl.sh" 'set -e'
}

@test "8.0.1 ssl.sh: creates self-signed cert if missing" {
