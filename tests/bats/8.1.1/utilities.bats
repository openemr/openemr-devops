# BATS: 8.1.1 utilities — devtoolsLibrary, unlock_admin
...
@test "8.1.1 utilities: devtoolsLibrary.source exists and is readable" {
    assert_file_exists "${UTILS}/devtoolsLibrary.source"
}

@test "8.1.1 utilities: devtoolsLibrary defines prepareVariables" {
    assert_script_contains "${UTILS}/devtoolsLibrary.source" 'prepareVariables()'
}

@test "8.1.1 utilities: devtoolsLibrary sets CONFIGURATION" {
    assert_script_contains "${UTILS}/devtoolsLibrary.source" 'CONFIGURATION='
}

@test "8.1.1 utilities: devtoolsLibrary uses MYSQL_* and OE_*" {
...
@test "8.1.1 utilities: devtoolsLibrary setGlobalSettings" {
    assert_script_contains "${UTILS}/devtoolsLibrary.source" 'setGlobalSettings'
}

@test "8.1.1 utilities: unlock_admin.sh exists and runs php" {
...
@test "8.1.1 utilities: unlock_admin.sh cd to /root" {
    assert_script_contains "${UTILS}/unlock_admin.sh" '/root'
}

@test "8.1.1 utilities: unlock_admin.php exists" {
