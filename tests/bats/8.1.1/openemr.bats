# BATS: 8.1.1 openemr.sh — main startup script behavior and structure
...
@test "8.1.1 openemr.sh: defines path constants OE_ROOT, AUTO_CONFIG, SQLCONF_FILE" {
...
@test "8.1.1 openemr.sh: sources devtoolsLibrary.source" {
    assert_script_contains "${SCRIPT_DIR}/openemr.sh" 'devtoolsLibrary.source'
}

@test "8.1.1 openemr.sh: defines MYSQL_* and OE_* env defaults" {
...
@test "8.1.1 openemr.sh: defines MANUAL_SETUP, K8S, SWARM_MODE" {
