# BATS: 8.1.0 ssl.sh — SSL/TLS configuration
...
@test "8.1.0 ssl.sh: uses set -e" {
    assert_script_contains "${SCRIPT_DIR}/ssl.sh" 'set -e'
}

@test "8.1.0 ssl.sh: creates self-signed cert if missing" {
