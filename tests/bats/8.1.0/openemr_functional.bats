# BATS: 8.1.0 openemr.sh — functional tests (early execution and role logic)
...
@test "8.1.0 openemr: with K8S=admin script does not immediately syntax-error" {
...
@test "8.1.0 openemr: CONFIGURATION is set after prepareVariables when sourced with env" {
