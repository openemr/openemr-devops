...
OpenEMR Cloud Express on the AWS Marketplace provides OpenEMR 8.4.0, an embedded MariaDB server, and rotated, automatic backups of all OpenEMR configuration and health information.
