...
volumes:
  ...
  databasevolume: {}
```
[![Try it!](https://github.com/play-with-docker/stacks/raw/cff22438cb4195ace27f9b15784bbb497047afa7/assets/images/button.png)](http://play-with-docker.com/?stack=https://gist.githubusercontent.com/bradymiller/fc131c884596abf372a1ca0c29ded688/raw/95442cff75cd3e80118571a4e763dcaaccd86f7f/openemr-flex-318-docker-example-docker-compose.yml)
...
Both 32 bit and 64 bit architectures are supported on Raspberry Pi. If you are using Raspberry Pi, then need to change the `mariadb:10.11` to `jsurf/rpi-mariadb` in the above docker-compose.yml example.
